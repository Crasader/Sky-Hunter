...
bool Level3::init()
{
	...
	//scheduleUpdate();
	schedule(schedule_selector(Level3::update));
	return true;
}
...
void Level3::awakeEnemyScheduler()
{
	//enemy ratio
	// set up the time delay
	DelayTime *delayAction = DelayTime::create(1.5f);
	// perform the selector call
	CallFunc *callSelectorAction = CallFunc::create(CC_CALLBACK_0(Level3::awakeEnemy, this));
